...
class MyGame(arcade.Window):
    ...
    def on_mouse_motion(self, x, y, dx, dy):
        ...
        """
        This above sets the balls position of x and y to follow the mouse motion. Used to make it so it will move around the screen!
        """
    ...
    def on_mouse_press(self, x, y, button, modifiers):
        ...
        if button == arcade.MOUSE_BUTTON_LEFT:
            ...
            """
            This above is very interesting to see because we haven't seen it yet. It can be used in so many different cases, not just to change the color. 
            I like it because it means python arcade can make some really really cool games in a simple way!
            """
